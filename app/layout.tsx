  ...
  return (
    <html lang="en" className="scroll-smooth">
      <body className={`${rajdhani.variable} ${jetbrainsMono.variable} font-sans antialiased`}>
        ...
        <Analytics />
      {/* v0 – built-with badge */}
  <div dangerouslySetInnerHTML={{ __html: `<div id="v0-built-with-button-8e657b39-4eff-4a83-b4d4-fb639e023ca5" style="
...
">
<a
  href="https://v0.app/chat/api/open/built-with-v0/b_LbN1QEG8gLV?ref=2NROJV"
  target="_blank"
  rel="noopener"
  style="
    color: inherit;
...
<button
  onclick="document.getElementById('v0-built-with-button-8e657b39-4eff-4a83-b4d4-fb639e023ca5').style.display='none'"
